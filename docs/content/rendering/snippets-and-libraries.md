...
[rendering endpoint](/rendering/rendering-endpoint/); a library is importable by any
snippet.
...
[Evaluation and security](/rendering/evaluation-and-security/).

For the operator-side equivalent — `JsonnetLibrary` CRDs and OCI-mounted shared
libraries — see [Jsonnet libraries](/rendering/jsonnet-libraries/).
