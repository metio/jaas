...
[Snippets and libraries](/rendering/snippets-and-libraries/) for how to declare
both.
...
[Evaluation and security](/rendering/evaluation-and-security/). To pass values into
a render, see
