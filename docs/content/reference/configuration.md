...
[Helm chart values](/reference/helm-values/) reference.
...
see [Evaluation and security](/rendering/evaluation-and-security/).
...
[External variables and TLAs](/rendering/external-variables-and-tlas/) for usage
examples.
...
[Evaluation and security](/rendering/evaluation-and-security/) for the full
discussion.
...
See [Admission webhook](/security/admission-webhook/) for the full `failurePolicy`
