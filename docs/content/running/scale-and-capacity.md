...
[Production](/running/production/) for the same sizing decision in the context
...
[Storage and HA](/operator/storage-and-ha/); pick a backend there before scaling out.
...
- [Storage and HA](/operator/storage-and-ha/) — pick the backend that lets you scale
  past one replica.
- [Production](/running/production/) — the full pre-production hardening
  checklist.
