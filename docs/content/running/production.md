...
[Storage and HA](/operator/storage-and-ha/) — including the garbage-collection grace
...
See [Scale and capacity](/running/scale-and-capacity/) for the resident-memory
reasoning behind a request/limit, and [Evaluation and security](/rendering/evaluation-and-security/)
...
[Admission webhook](/security/admission-webhook/).
...
automatically. Read
[Upgrading](/reference/upgrading/) before
...
- [Operations](/running/operations/) — day-two tasks: rolling restarts,
  storage sweeping, finalizer teardown.
- [Scale and capacity](/running/scale-and-capacity/) — replica sizing, the
  HA model, throughput knobs, and the saturation signals to watch.
- [Configuration reference](/reference/configuration/) — every flag and default.
